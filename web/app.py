...
# === Endpoint aliases (compatibilidade com templates antigos) ===
try:
    if 'campanhas' not in app.view_functions and 'campanhas_qtd' in app.view_functions:
        app.add_url_rule('/campanhas', endpoint='campanhas', view_func=app.view_functions['campanhas_qtd'], methods=['GET'])
    if 'relatorios_campanhas' not in app.view_functions and 'relatorio_campanhas' in app.view_functions:
        app.add_url_rule('/relatorios/campanhas', endpoint='relatorios_campanhas', view_func=app.view_functions['relatorio_campanhas'], methods=['GET'])
except Exception:
    # não falhar o boot por causa de alias
    pass
